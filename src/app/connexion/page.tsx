...
export default function ConnexionPage() {
  return (
    <section className="min-h-[calc(100vh-var(--header-h,0px))] bg-[#f4f6f1] px-4 py-10 text-slate-950 sm:px-6 lg:px-8">
      <div className="mx-auto grid min-h-[calc(100vh-var(--header-h,0px)-5rem)] w-full max-w-6xl items-center gap-8 lg:grid-cols-[1fr_440px]">
