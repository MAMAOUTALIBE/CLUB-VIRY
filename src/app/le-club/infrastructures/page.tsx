...
export default async function InfrastructuresPage() {
  ...
  return (
    <>
        ...
        <div className="grid gap-3 pb-2">
          <MobileCard>
            <p className="text-sm font-semibold leading-6 text-slate-700">
              Le stade Henri Longuet, les terrains et tous les espaces qui accueillent la vie sportive et associative du club.
            </p>
            <nav aria-label="Sections des infrastructures" className="mt-4 grid gap-2">
              <a className="focus-ring inline-flex min-h-11 items-center justify-center rounded-md bg-[#f7c600] px-4 text-sm font-black uppercase text-[#001c10]" href="#installations">
                Toutes les installations
              </a>
              <a className="focus-ring inline-flex min-h-11 items-center justify-center rounded-md border border-[#07542f]/20 bg-white px-4 text-sm font-black uppercase text-[#002f1d]" href="#stade-henri-longuet">
                Stade Henri Longuet
              </a>
            </nav>
          </MobileCard>
      ...
      {/* Sections cibles des ancres : rendues a toutes les largeurs pour que
          /le-club/installations et /le-club/stade-henri-longuet aboutissent aussi sur mobile. */}
      <section id="installations" className="scroll-mt-[var(--header-h)] mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 xl:py-14">
      ...
      <section id="stade-henri-longuet" className="scroll-mt-[var(--header-h)] bg-[#f7f8f4] px-4 py-10 sm:px-6 lg:px-8 xl:py-14">
