...
export default async function ValeursPartenairesPage() {
  ...
  return (
    <>
        ...
        <div className="grid gap-3 pb-2">
          <MobileCard>
            <p className="text-sm font-semibold leading-6 text-slate-700">
              Les règles qui nous rassemblent et les partenaires qui rendent le projet du club possible.
            </p>
            <nav aria-label="Sections valeurs et partenaires" className="mt-4 grid gap-2">
              <a className="focus-ring inline-flex min-h-11 items-center justify-center rounded-md bg-[#f7c600] px-4 text-sm font-black uppercase text-[#001c10]" href="#valeurs">
                Valeurs et conduite
              </a>
              <a className="focus-ring inline-flex min-h-11 items-center justify-center rounded-md border border-[#07542f]/20 bg-white px-4 text-sm font-black uppercase text-[#002f1d]" href="#partenaires">
                Partenaires
              </a>
              <a className="focus-ring inline-flex min-h-11 items-center justify-center rounded-md border border-[#07542f]/20 bg-white px-4 text-sm font-black uppercase text-[#002f1d]" href="#devenir-partenaire">
                Devenir partenaire
              </a>
            </nav>
          </MobileCard>
      ...
      {/* Sections cibles des ancres : rendues à toutes les largeurs pour que
          /partenaires et /le-club/codes-de-conduite aboutissent aussi sur mobile. */}
      <section id="valeurs" className="scroll-mt-[var(--header-h)] mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 xl:py-14">
        ...
        <div className="mb-8 flex flex-col gap-4 rounded-lg border border-[#07542f]/12 bg-white p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h2 className="mt-1 text-xl font-black uppercase text-[#002f1d] sm:text-2xl">Code de bonne conduite complet</h2>
          </div>
      ...
      <section className="bg-[#f7f9f5] px-4 py-10 sm:px-6 lg:px-8 xl:py-14">
      ...
      <section id="partenaires" className="scroll-mt-[var(--header-h)] mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8 xl:py-14">
        <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <div className="club-panel rounded-lg p-6 text-white">
            <h2 className="text-2xl font-black uppercase text-[#f7c600] sm:text-3xl">Devenez partenaire du club</h2>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4 lg:grid-cols-3">
              {partners.map((partner) => (
                <div className="official-card flex min-h-24 items-center justify-center rounded-lg bg-white p-4 text-center sm:p-6" key={partner.name}>
                  {partner.logoUrl ? <img src={partner.logoUrl} alt={partner.name} className="mx-auto max-h-16 w-auto object-contain" /> : <span className="text-base font-black text-[#002f1d] sm:text-xl">{partner.name}</span>}
                </div>
              ))}
            </div>
          </div>
      ...
      <section id="devenir-partenaire" className="scroll-mt-[var(--header-h)] mx-auto max-w-3xl px-4 pb-12 sm:px-6 lg:px-8 xl:pb-16">
        <div className="official-card rounded-2xl bg-white p-5 sm:p-8"><PartnerForm /></div>
      </section>
    </>
  );
}
