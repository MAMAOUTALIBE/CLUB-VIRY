...
const NAVIGATION: NavGroup[] = [
  ...
  { label: "Configuration", icon: Settings, children: [{ label: "Utilisateurs", href: "/admin/utilisateurs" }, { label: "Champs personnalisés", href: "/admin/champs" }, { label: "Journal d’audit", href: "/admin/journal" }, { label: "Corbeille", href: "/admin/corbeille" }, { label: "Paramètres", href: "/admin/parametres" }] }
];
