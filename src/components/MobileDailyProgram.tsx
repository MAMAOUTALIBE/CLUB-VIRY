...
export function MobileDailyProgram({ items, now }: { items: CalendarDisplayItem[]; now: Date }) {
  ...
  const visibleDailyItems = dailyItems.slice(0, 3);
