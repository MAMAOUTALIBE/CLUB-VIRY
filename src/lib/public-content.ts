...
const mockEducators: DisplayEducator[] = [
  ...
  },
  {
    ...
    title: "Éducateur U14",
    diploma: "CFI",
    slug: educatorSlug("LULUNGU Howen", "mock-12"),
    joinedYear: null,
    diplomas: ["CFI"],
    specialties: [],
    quote: null,
  ...
  },
  {
    ...
    title: "Éducateur U13",
    diploma: "BMF",
    slug: educatorSlug("ROBERTO Kévin", "mock-13"),
    joinedYear: null,
    diplomas: ["BMF"],
    specialties: [],
    quote: null,
    avatar: null,
    bio: "Éducateur de la catégorie U13.",
    teams: [{ name: "U13", slug: "u13", category: "U13", roleTitle: "Éducateur", isHeadCoach: true }],
    stats: { teams: 1, sessions: 0, matches: 0 }
  },
  {
    id: "mock-2",
    name: "BUANGA Thismen",
    title: "Responsable École de foot",
    diploma: null,
    slug: educatorSlug("BUANGA Thismen", "mock-2"),
    joinedYear: null,
    diplomas: [],
    specialties: ["Accueil familles", "Projet éducatif"],
    quote: null,
    avatar: null,
    bio: "Responsable de l'école de foot, il coordonne les catégories U6 à U13.",
    teams: [{ name: "École de foot", slug: "ecole-de-foot", category: "U6 à U13", roleTitle: "Responsable École de foot", isHeadCoach: true }],
    stats: { teams: 1, sessions: 0, matches: 0 }
  },
  {
    id: "mock-14",
    name: "WILLAUME Axel",
    title: "Éducateur U6-U7",
    diploma: null,
    slug: educatorSlug("WILLAUME Axel", "mock-14"),
    joinedYear: null,
    diplomas: [],
    specialties: ["Motricité", "Plaisir"],
    quote: null,
    avatar: null,
    bio: "Éducateur des catégories U6-U7 à l'école de foot.",
    teams: [{ name: "École de foot", slug: "ecole-de-foot", category: "U6-U7", roleTitle: "Éducateur U6-U7", isHeadCoach: false }],
    stats: { teams: 1, sessions: 0, matches: 0 }
  },
  {
    id: "mock-15",
    name: "DITSIA PHUMU Nobela",
    title: "Éducatrice U8-U9",
    diploma: null,
    slug: educatorSlug("DITSIA PHUMU Nobela", "mock-15"),
    joinedYear: null,
    diplomas: [],
    specialties: ["Technique", "Vie collective"],
    quote: null,
    avatar: null,
    bio: "Éducatrice des catégories U8-U9 à l'école de foot.",
    teams: [{ name: "École de foot", slug: "ecole-de-foot", category: "U8-U9", roleTitle: "Éducatrice U8-U9", isHeadCoach: false }],
    stats: { teams: 1, sessions: 0, matches: 0 }
  },
  {
    id: "mock-16",
    name: "COULIBALY Bagnoucou",
    title: "Éducateur U10-U11",
    diploma: null,
    slug: educatorSlug("COULIBALY Bagnoucou", "mock-16"),
    joinedYear: null,
    diplomas: [],
    specialties: ["Jeu court", "Autonomie"],
    quote: null,
    avatar: null,
    bio: "Éducateur des catégories U10-U11 à l'école de foot.",
    teams: [{ name: "École de foot", slug: "ecole-de-foot", category: "U10-U11", roleTitle: "Éducateur U10-U11", isHeadCoach: false }],
    stats: { teams: 1, sessions: 0, matches: 0 }
  },
  {
    id: "mock-4",
