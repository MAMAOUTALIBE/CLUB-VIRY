-- Diplôme / licence public des éducateurs (ex. "UEFA C", "BEF", "CFF3").
-- Affiché en badge sur la page publique Encadrement.

alter table public.profiles add column if not exists public_diploma text;

-- La signature change (nouvelle colonne diploma) : il faut DROP avant CREATE.
...
-- DROP FUNCTION a supprimé les GRANT d'origine : on les rétablit.
